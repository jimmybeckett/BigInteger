...
BOOST_AUTO_TEST_CASE(construct_postive_string) {
    BOOST_CHECK(BigInteger ("653290873988655678883093619305836176201") == "653290873988655678883093619305836176201");
}

BOOST_AUTO_TEST_CASE(construct_negative_string) {
    BOOST_CHECK(BigInteger ("-98736983509287136022078") == "-98736983509287136022078");
}
